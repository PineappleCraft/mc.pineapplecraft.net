...
## Paper Changelog: 18/12/2023

* Updated Paper to 1.20.2 Build 318
* Updated Plugins [plugin-changelog.md](plugin-changelog.md)

* * *

## Proxy Changelog: 18/12/2023

* Updated Waterfall to 1.20 Build 558
* Updated Plugins [plugin-changelog.md](plugin-changelog.md)
